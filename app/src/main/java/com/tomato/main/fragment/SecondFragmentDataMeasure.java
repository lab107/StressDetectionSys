...
public class SecondFragmentDataMeasure extends Fragment {
    private final int FRAGMENTCODE=2;     //Fragmmet的编号
...
//            double[]y1 = bundle.getDoubleArray("y1");
//            mService.drawMeasureChart(x, y,status );
//            mService1.drawMeasureChart(x,y1,status );
